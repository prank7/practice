...
#function is executed if the boolean is true, and the second if it's false,
#like an if/else statament, so that we don't have to mess around with those nasty keywords!
